...
<>
  ...
  <header className="page-header" role="banner">
    ...
    <h2 className="project-tagline">
      Getting Ready for the Next Generation and Future of the Internet - Join a
      13 Trillion Dollar Industry with 5 Billion Users
    </h2>
  </header>
  <main id="content" className="main-content" role="main">
    <h1 id="certified-web-30-and-metaverse-developer-a-nationwide-program-in-karachi-lahore-islamabad-and-peshawar">
      Certified Web 3.0 and Metaverse Developer: A Nationwide Program in
      Karachi, Lahore, Islamabad, and Peshawar
    </h1>
    <p>
    ...
    <h2 id="admissions-now-open-in-karachi-lahore-islamabad-and-peshawar">
    ...
    <p>
      ...
      development in human history. Web3 and metaverse technologies expand the
      internet as we know it by introducing novel features and advancements.
      Metaverse will make use of all aspects of modern technology, including 3D,
      VR, AR, AI, blockchain, cloud computing, voice computing, ambient
      computing, and more.
    </p>
    <p>
      ...
      centred on decentralised technologies and virtual worlds. Citi stated in a
      March 2022{" "}
      <a href="https://www.citivelocity.com/citigps/metaverse-and-money/">
        research paper
      </a>{" "}
      that the metaverse economy might have a total addressable market of up to
      $13 trillion and five billion people by 2030.
    </p>
    <h2 id="the-program-in-a-nutshell-earn-while-you-learn">
    ...
    <h2 id="core-courses-common-in-all-specializations">
    ...
    <h2 id="web-30-blockchain-and-metaverse-specialization">
    ...
    <p>
      <a href="">
        Quarter III W3-351: Developing Smart Contracts and Planet-Scale Web 3.0
        Dapps
      </a>
    </p>
    <p>
    ...
    <h2 id="artificial-intelligence-ai-and-deep-learning-specialization">
    ...
    <p>
      <a href="">
        Quarter III AI-351: Developing Planet-Scale Intelligent APIs and Python
        Programming
      </a>
    </p>
    <p>
      <a href="">Quarter IV AI-361: Deep Learning and MLOps</a>
    </p>
    <h2 id="cloud-native-computing-specialization">
    ...
    <h2 id="ambient-computing-and-iot-specialization">
    ...
    <p>
      <a href="">Quarter IV AC-361: Embedded Programming using C and Rust</a>
    </p>
    <h2 id="the-outcome-for-participants-of-the-program">
      The Outcome for Participants of the Program
    </h2>
    <p>
      The graduates of this program will own products (Full-Stack App Templates,
      AR and VR Experiences, and APIs) that are marketed globally by the
      Panaverse DAO and, if they like, will also be able to start off by
      offering services at a rate of $50 per hour ($96,000 per year). This would
      give Pakistani professionals and students a fantastic opportunity to
      better their financial situation while also giving the economy a
    ...
    <h2 id="cs-101-object-oriented-programming-using-typescript">
      CS-101: Object-Oriented Programming using TypeScript
    </h2>
    <p>Duration: 13 Weeks</p>
    <p>Course Description:</p>
    <p>
      We will start the program by learning the fundamentals of Object-Oriented
      programming using JavaScript and TypeScript. We will also understand the
      latest Web trends i.e. Web 3.0 and Metaverse concepts and try to
    ...
    <p>
      <a href="https://docs.google.com/presentation/d/12C1s4UBTlR9nZNEkRE6aAuGeRA3s92jx-8nJKo9jdH4/edit?usp=sharing">
        Introduction to Panaverse DAO
      </a>
    </p>
    <p>
      <a href="https://docs.google.com/presentation/d/1FSbr9aJwO0-fmZHqWy_eHO2N_jwJLmQCy4cG8rd4ctw/edit?usp=sharing">
        Web 3.0 User Guide
      </a>
    </p>
    <p>Complete Web 3 Assignments included in the Web 3 User Guide</p>
    <p>
      <a href="https://docs.google.com/presentation/d/1ADk87hQ0Etr2PfmN9XH7TQ0CHl6XSP_7JWNUbzPdDNc/edit?usp=sharing">
        Virtual and Augmented Metaverse User Guide
      </a>
    </p>
    <h3 id="fundamentals-of-javascript-ecmascript-2022-language-specification">
    ...
    <ol>
      <li>
        ...
        <br />
        How to accept user input in your Node.js JavaScript programs, this will
        allow us to create interactive Node.js console programs using
        prompt-sync library. The last example in this presentation shows you how
        to use prompt-sync library in your Node.js programs:
        https://docs.google.com/presentation/d/1eOLJTN0FyVAw6lMUvA_XYLORKnudWXyzXsB6sg5oPIs/edit?usp=sharing
        <br />
        Note: After this point, we will do all our class work and exercises
        using Node.js in .mjs files. We will also be able to develop interactive
        Node.js console programs which will greatly help the students to learn.
      </li>
      <li>
      ...
      <li>
        Using if and if else statements, else if statements, Conditional ternary
      ...
      <li>
        ...
        and Function callbacks in Node.js (chapter 6 of JavaScript from Beginner
        to Professional)
      </li>
      <li>
    ...
    <p>
      Chapters 1-11 of Learning TypeScript: Enhance Your Web Development Skills
    ...
    <p>
      ...
      Dashboards, and Muti-Cloud Serverless APIs. By the end of the quarter, the
      participants will be able to develop and deploy web platforms like
      Facebook, Shopify, etc. The technologies covered in this course will
      include Next.js 13, Figma, Tailwind CSS, Chakra UI, tRPC, QraphQL, Prisma,
    ...
    <p>
      <a href="https://beta.nextjs.org/docs">Next 13 Official Documentation</a>
    </p>
    <p>
    ...
    <p>
      <a href="https://www.amazon.com/Designing-Prototyping-Interfaces-Figma-interactive/dp/180056418X/ref=sr_1_1_sspa">
        ...
        design principles by creating interactive prototypes for mobile, tablet,
        and desktop by Fabio Staiano
      </a>
    </p>
    <p>
    ...
    <p>
      <a href="https://nextjs.org/docs/api-routes/introduction">API Routes</a>
    </p>
    ...
    <p>
      Note: For AWS Free Tier you will need a credit or debit card. The easiest
      way for Pakistani students is to open a bank account with Meezan Bank.
      Open a Meezan Aasan Account if you have no earning proof. Meezan Bank will
      charge Rs. 1100 for ATM Debit Card and there is a requirement of Rs. 100
      minimum deposit. The card will be delivered in a few weeks. Our students
      have reported that this Debit card works with AWS.
    </p>
    <p>
      ...
      accounts. This is good news for those students who find it difficult to
      create physical debit and credit cards from banks.
    </p>
    <p>
    ...
    <h3 id="multi-cloud-graphql-serverless-api-development-with-cloud-development-kit-for-terraform-cdktf-remote-zoom-class">
      Multi-Cloud GraphQL Serverless API Development with Cloud Development Kit
      for Terraform (CDKTF) (Remote Zoom Class)
    </h3>
    <p>
      <a href="https://github.com/panaverse/learn-multicloud-api-development">
        Learn Multicloud Serverless API Development using CDK Terraform in Baby
        Steps
      </a>
    </p>
    ...
    <p>
      ...
      of the revenues will be distributed to the developer through the Panaverse
    ...
    <p>
      ...
      revenues will be distributed to the developer through the Panaverse DAO in
    ...
    <p>
      ...
      project, deploy it in production, write smart contracts, unit test them,
      and create user interfaces for them. We will also learn to develop ERC-20
      and NFT tokens, DAOs, Oracles, etc. Please note that in order to develop
      Web 3 applications you also need to build on top of Web 2.0 technologies
      which we have already covered in the previous quarters.
    </p>
    <p>
    ...
    <p>
      <a href="https://github.com/panaverse/dapps-nextjs">Dapp Learning Repo</a>
    </p>
    ...
    <p>
      ...
      IDOsTop-Rated Crypto Token Sales: List of New ICOs, STOs, IEOs and IDOs
    ...
    <p>
      Your first task of the project is to make a google slides presentation on
      how to start a IEO on the Binance Launch Pad
    ...
    <p>
      Your second task of the project is to make a google slides presentation on
      how to start a IDO on the Polkastarter https://polkastarter.com/
    </p>
    ...
    <p>
      ...
      create some kind of paid decentralized service in the future.
    </p>
    <p>
      Therefore, for the sake of this chapter, let’s imagine that our Pako DApp
      uses its own coin – the Pako Token. We will create two contracts – one for
      the token itself and one for the token crowd sale (the ICO).
    </p>
    <p>
      Now Create your own Pako ERC20 Token and deploy it on a testnet. The Token
      should be to use OpenZeppelin contracts. You will use the Hardhat
    ...
    <p>
      Emit a BuyTokens event that will log who’s the buyer, the amount of ETH
      sent and the amount of Token bought
    </p>
    <p>
      Transfer 75% of the Tokens to the Crowd Sale contract at deployment time.
      i.e. Right after the contract is deployed, we want the token contract to
      send 75% of our token supply to it. While 25% remain in our personal
      “owner” account.
    </p>
    <p>
      Transfer the ownership of the Crowd Sale contract (at deploy time) to our
      frontend address so that we are able to withdraw the ETH.
    </p>
    <p>
      You can use the openzeppelin crowd sale contracts
      https://docs.openzeppelin.com/contracts/4.x/crowdsales however you will
      have to update the code to the latest solidity version.
    </p>
    <p>
      Also write extensive tests, for example we will simply send a transaction
      of 1 ETH from a random account to the contract. After the transaction, we
      should expect the account to have received Pako, while the contract’s
    ...
    <p>
      While it’s always good to test your code, it’s often more satisfying to
      see the results of your work wrapped in a nice UI. Let’s see how we can
      deploy our contracts and get some Pako tokens into our MetaMask wallet!
    </p>
    <p>
      We start by running our deployment scripts for the test network so that
      the new token contracts are uploaded and deployed.
    </p>
    <p>
      When it’s done, take note of what addresses the contracts were uploaded to
      and copy it!
    </p>
    <p>
      Now head to MetaMask, and send a transaction of 1 ETH to the crowd sale
      contract address. If your MetaMask wallet doesn’t have any ethers,
      remember that you can use any faucet.
    </p>
    <p>
      After the transaction has been confirmed, you might be confused about why
      you can’t see any tokens in your wallet. It turns out that you need to
      manually add the token address in MetaMask in order to “register” it –
      after all, there are so many tokens out there, there’s no way MetaMask
      could list them all by default!
    </p>
    <p>
      To do this, open the side menu and click on the “Add token” button to get
      started:
    </p>
    <p>
      Once you’re on the token page, click on “Add custom token” and paste in
      the token contract’s address in the address field.
    </p>
    <p>
      After confirming that you want to add the token, you should be able to see
      your Pako balance right next to your ETH balance in the wallet. How cool!
    </p>
    ...
    <p>
      ...
      MetaMask wallet and list it on OpenSea Marketplace https://opensea.io/ for
      sale.
    </p>
    <p>
    ...
    <p>
      ...
      connects all of the metaverses so that we can travel between them. This is
      only achievable with open web-based metaverses. The internet and its
      browsers are magical. Federated but linked experiences connect pages,
      people, technology, businesses, standards, and nations. It’s unlike
      anything else. The metaverse should replicate the best qualities of the
      web - it should just be the web. We just have to extend online responsive
      design from mobile to desktop to 3D, Augmented Reality, and Virtual
      Reality. This course will teach you how to build the Open Social Spatial
    ...
    <p>
      Assignment 2: Build a Viking Scene using Blender 3 as shown in chapter 2
